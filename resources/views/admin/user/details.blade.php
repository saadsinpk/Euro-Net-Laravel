                ...
                <div class="modal fade" id="kt_modal_update_admin" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            <!--begin::Form-->
                            <form class="form" action="{{ url('admin/users/update') }}" id="kt_modal_update_admin_form" enctype="multipart/form-data" novalidate="novalidate">
                                <input id="id" name="id" type="hidden" value="{{ $user->id }}">
                                <!--begin::Modal header-->
                                <div class="modal-header" id="kt_modal_update_admin_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">{{__('form.Update a user') }}</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_update_email_form" class="form" action="{{ url('admin/users/update') }}">
                                    <!--begin::Notice-->
                                    <!--begin::Notice-->
                ...
                <div class="modal fade" id="kt_modal_update_password" tabindex="-1" aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                <!--begin::Form-->
                                <form id="kt_modal_update_password_form" class="form" action="{{ url('admin/users/update') }}">
                                    <div class="fv-row mb-7">
...
@section("after_script")
    ...
    <script src="{{ asset('public/assets/js/custom/apps/users/update.js') }}"></script>
