            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title">
                    ...
                    @if(isset($message_to_display))
                        @if($message_to_display == 'pass')
                            <p style="    font-size: 20px;    font-weight: bold;">{{__('form.User is verify now') }}</p>
                        @endif
                    @endif
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon-->
                        <input type="text" data-kt-admin-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="{{__('form.Search users') }}" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-admin-table-toolbar="base">
                        <!--begin::Add admin-->
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_admin">{{__('form.Add a user') }}</button>
                        <!--end::Add admin-->
                    </div>
                    <!--end::Toolbar-->
                    <!--begin::Group actions-->
        ...
        <div class="modal fade" id="kt_modal_add_admin" tabindex="-1" aria-hidden="true">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                ...
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="{{ url('admin/users') }}" id="kt_modal_add_admin_form" data-kt-redirect="{{ url("admin/users") }}">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_add_admin_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bolder">{{__('form.Add a user') }}</h2>
                            <!--end::Modal title-->
                            <!--begin::Close-->
...
@section("after_script")
    ...
    <script src="{{ asset('public/assets/js/custom/apps/users/list.js') }}"></script>
    <!--end::Javascript-->
@endsection