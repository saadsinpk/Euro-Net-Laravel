                            ...
                            <div class="position-relative w-100 p-10 justify-content-between">
                               <div>
                                    ...
                                    @if($rPayment->status == '7')
                                        {{ __('form.Tracking Number') }}:<b>{{$rPayment->return_tracking_number}}</b><br>
                                        {{ __('form.Shipping Company') }}:<b>{{$rPayment->return_shipping_company}}</b><br>
                                    @endif
                                    @if($rPayment->status == '2')
                                        <form action="" method="post" id="ship_form">
                                            @csrf
                                            <label>{{ __('form.Shipping company') }}</label>
                                            ...
                                            <label>{{ __('form.Tracking Number') }}</label>
                                    ...
                                    @endif
                                    @if($rPayment->status == '2' || $rPayment->status == '7')
                                        <a href="{{url('label/download/'.$rPayment->number)}}" class="btn btn-primary" target="_blank">Download LABEL</a>
                                        <div class="separator separator-dashed mb-7"></div>
                                    @endif
