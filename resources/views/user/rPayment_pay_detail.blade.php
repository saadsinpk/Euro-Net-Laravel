                        ...
                        <div class="d-flex flex-column align-items-start justify-content-center flex-equal me-5">
                            ...
                            <div class="position-relative w-100 p-10 justify-content-between">
                               <div>
                                    ...
                                    <form action="{{ url('charge') }}" method="post" id="payment-form"  style="width:100%;">
                                        <div class="form-row">
                                            <p><input type="hidden" name="repair_id" value="{{$rPayment->id}}" /></p>
                                            <p><input type="hidden" name="pay_id" value="{{$payid}}"/></p>
                                        ...
                                        <p><button class="btn btn-primary">
                                            <span class="indicator-label">Submit Payment</span>
                                        </button></p>
                                        {{ csrf_field() }}
                                    </form>
                                </div>
